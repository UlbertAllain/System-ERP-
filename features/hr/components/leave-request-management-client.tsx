...
export function LeaveRequestManagementClient({
  ...
  function handleCancelLeaveRequest(id: string) {
    const confirmed = window.confirm(
      "Yakin ingin membatalkan leave request ini?",
    );
  ...
  function handleApproveLeaveRequest(id: string) {
    const confirmed = window.confirm("Setujui leave request ini?");
              ...
              <div className="grid gap-5 py-2">
                ...
                <div className="grid gap-2">
                  ...
                  <Textarea
                    ...
                    placeholder="Jelaskan alasan leave request..."
                    rows={4}
                  />
                </div>
                      ...
                      <TableCell className="min-w-[220px]">
                        ...
                        {leaveRequest.rejectedReason ? (
                          <p className="mt-1 text-xs text-destructive">
                            Rejected: {leaveRequest.rejectedReason}
                          </p>
                        ) : null}
                      </TableCell>
