...
export function AttendanceManagementClient({
  ...
  function handleClockOut() {
    if (!ownTodayAttendance) {
      setMessage("Attendance hari ini belum ditemukan.");
      return;
    }
  ...
  function handleUpdateAttendance() {
    if (!editForm) {
      setMessage("Data attendance tidak ditemukan.");
      return;
    }
  ...
  function handleDeleteAttendance(attendance: AttendanceRecordListItem) {
    const confirmed = window.confirm(
      `Yakin ingin menghapus attendance ${attendance.employeeName} tanggal ${attendance.date}?`,
    );
      ...
      <div className="flex flex-col justify-between gap-4 md:flex-row md:items-start">
        <div>
          ...
          <p className="mt-2 text-sm text-muted-foreground">
            Clock in/out harian, monitoring attendance, dan koreksi manual oleh
            HR.
          </p>
        </div>
      </div>
          ...
          <CardContent className="space-y-4">
            ...
            <div className="grid gap-4 md:grid-cols-2">
              <div className="grid gap-2">
                <Label htmlFor="clockInDate">Date</Label>
                <Input
                  id="clockInDate"
                  type="date"
                  value={clockInDate}
            ...
            <div className="grid gap-2">
              <Label htmlFor="clockInNotes">Notes</Label>
              <Textarea
                id="clockInNotes"
                rows={3}
                value={clockInNotes}
        ...
        <DialogContent className="max-w-xl">
          <DialogHeader>
            ...
            <p className="text-sm text-muted-foreground">
              Koreksi manual attendance hanya untuk user dengan permission
              attendance.update.
            </p>
          </DialogHeader>
