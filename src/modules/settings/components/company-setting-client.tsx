    ...
    <div className="space-y-6">
      ...
      <div className="grid gap-6 xl:grid-cols-[360px_1fr]">
        <Card>
          ...
          <CardContent className="space-y-4">
            ...
            <div className="grid gap-2">
              <Label htmlFor="companyLogo">Unggah Logo</Label>
              <Input
                id="companyLogo"
                type="file"
        ...
        <div className="space-y-6">
          ...
          <Card>
            <CardHeader>
              <CardTitle>Pengaturan Keuangan dan Tagihan</CardTitle>
            </CardHeader>

            <CardContent className="grid gap-5">
              <div className="grid gap-4 md:grid-cols-4">
                <div className="grid gap-2">
                  <Label htmlFor="invoicePrefix">Awalan Nomor Tagihan</Label>
                  <Input
                    id="invoicePrefix"
                ...
                <div className="grid gap-2">
                  <Label htmlFor="expensePrefix">Awalan Nomor Pengeluaran</Label>
                  <Input
                    id="expensePrefix"
              ...
              <div className="grid gap-2">
                <Label htmlFor="invoiceNotes">Catatan Default Tagihan</Label>
                <Textarea
                  id="invoiceNotes"
